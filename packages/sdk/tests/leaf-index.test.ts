...
import { leafIndexFromLogs } from "../src/utxo/leaf-index.js";
...
function logLine(d: Uint8Array, bodyLen: number, leafOffset: number, leafIndex: bigint): string {
...
describe("leafIndexFromLogs", () => {
  ...
  it("returns null on a truncated event body", () => {
    ...
    expect(leafIndexFromLogs([short], NOTE_CREATED, NOTE_CREATED_OFF)).toBeNull();
  });
});
