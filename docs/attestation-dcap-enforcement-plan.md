...
> [`../audit_2/READINESS.md`](../audit_2/READINESS.md) finding **A-1** (gap).
>
...
**Primary finding:** `audit_2/READINESS.md` **A-1** — attestation trust anchor not enforced end-to-end  
...
5. **A-1 closed** in `audit_2/READINESS.md` with PR references (or formal acceptance if product chooses option B — not recommended).
...
| `audit_2/READINESS.md` | Close A-1 |
...
- [ ] `audit_2/READINESS.md` A-1 marked remediated with links  
