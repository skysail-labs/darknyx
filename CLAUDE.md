...
bash scripts/check-no-process-markers.sh            # darknyx-tee headers must say what is TRUE
                                                    ...
                                                    #   crates/darknyx-tee/CONTRIBUTING.md.
