...
mod tests {
    ...
    fn test_set_default_device() {
        ...
        {
            let main_device = test_utilities::TEST_MAIN_DEVICE.lock().unwrap();
    ...
    fn test_copy() {
        ...
        // H -> D -> D -> H
        {
            ...
            h_output.copy(&d_mem2[0..input.len()]).unwrap();
            assert_eq!(input, output);
        }
