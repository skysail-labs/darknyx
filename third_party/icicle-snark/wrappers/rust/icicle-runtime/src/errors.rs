...
impl Display for eIcicleError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            eIcicleError::SynchronizationFailed => {
                write!(f, "eIcicleError::SYNCHRONIZATION_FAILED")
            }
            eIcicleError::StreamCreationFailed => write!(f, "eIcicleError::STREAM_CREATION_FAILED"),
            eIcicleError::StreamDestructionFailed => {
                write!(f, "eIcicleError::STREAM_DESTRUCTION_FAILED")
            }
