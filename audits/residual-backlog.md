...
> **Update 2026-08-02 — both Criticals are CLOSED.** `SW-07` (with `SW-24`)
...
> Next: the `SW-01` code fix, then `SW-02`/`SW-03`. `D-04`'s re-entry condition
> is one finding from being met.
>
