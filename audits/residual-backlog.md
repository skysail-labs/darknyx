...
> closing all three of the executive answer's findings. Next: `SW-02`/`SW-03`,
> which the report says to fix together. **`D-04`'s re-entry condition is now
> met** — pull it in when convenient.
>
